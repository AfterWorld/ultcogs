...
class OnePieceFun(commands.Cog):
    ...
    def __init__(self, bot: Red):
        ...
        self.questions = [
            ...
            ("What is the name of Luffy's pirate crew?", "Straw Hat Pirates", "It's named after an accessory", "It involves a type of headwear", "It starts with 'Straw'", "easy"),
            ("Who is the cook of the Straw Hat Pirates?", "Sanji", "He's known for his kicks", "He has a curly eyebrow", "His name starts with 'S'", "easy"),
            ...
            ("What type of fruit did Chopper eat?", "Human-Human Fruit", "It turned an animal into a hybrid", "It's related to humans", "It's the ____ ____ Fruit", "normal"),
            ("Who is the archaeologist of the Straw Hat Pirates?", "Nico Robin", "She can sprout body parts", "Her first name is the same as a common male name", "Her full name is N___ R____", "easy"),
            ...
            ("Who is the main antagonist of the Dressrosa arc?", "Doflamingo", "He's a former Shichibukai", "He wears pink feathers", "His name starts with 'D'", "normal"),
            ("What is the name of Luffy's brother?", "Portgas D. Ace", "He has fire powers", "His first name is a card value", "His full name is P_____ D. A__", "easy"),
            ("Who is the shipwright of the Straw Hat Pirates?", "Franky", "He's a cyborg", "He loves cola", "His name rhymes with 'cranky'", "easy"),
            ("What is the name of Nami's weapon?", "Clima-Tact", "It controls the weather", "It's a staff-like weapon", "It starts with 'Clima'", "normal"),
            ...
            ("Who is the musician of the Straw Hat Pirates?", "Brook", "He's a skeleton", "He loves asking to see panties", "His name is a type of small stream", "easy"),
            ("What is the name of the Revolutionary Army's leader?", "Monkey D. Dragon", "He's Luffy's father", "He shares Luffy's family name", "His full name is M_____ D. D_____", "normal"),
            ("Which former Shichibukai is known as the 'Hawk-Eye'?", "Dracule Mihawk", "He's the world's greatest swordsman", "His eyes resemble a hawk's", "His first name is D______", "normal"),
            ...
            ("Who is the captain of the Heart Pirates?", "Trafalgar D. Water Law", "He's a surgeon", "He has the Op-Op Fruit", "His first name is T________", "normal"),
            ...
            ("Who is the creator of the Pacifista?", "Dr. Vegapunk", "He's a genius scientist", "He works for the World Government", "His title is 'Dr.'", "normal"),
            ("What is the name of Luffy's grandfather?", "Monkey D. Garp", "He's a Marine hero", "He shares Luffy's family name", "His full name is M_____ D. G___", "easy"),
            ("Which Yonko is known as 'Big Mom'?", "Charlotte Linlin", "She rules Whole Cake Island", "She has many children", "Her first name is C________", "normal"),
            ...
            ("Who is the sniper of the Straw Hat Pirates?", "Usopp", "He has a long nose", "He's known for his lies", "His name sounds like 'you sob'", "easy"),
            ...
            ("Which Devil Fruit did Ace eat?", "Mera Mera no Mi", "It's a Logia type", "It's related to fire", "It starts with 'Mera'", "normal"),
            ...
            ("Who is the captain of the Kid Pirates?", "Eustass Kid", "He has magnetic powers", "He's part of the Worst Generation", "His last name is 'Kid'", "normal"),
            ...
            ("Which Yonko is known as 'Blackbeard'?", "Marshall D. Teach", "He has two Devil Fruit powers", "He was part of Whitebeard's crew", "His first name is M_______", "normal"),
            ...
            ("Who is the helmsman of the Straw Hat Pirates?", "Jinbe", "He's a fishman", "He was a former Shichibukai", "His name starts with 'J'", "normal"),
            ("What is the name of the technique Luffy uses to predict enemy attacks?", "Observation Haki", "It's a type of Haki", "It allows the user to sense things", "It starts with 'Observation'", "normal"),
            ...
            ("Who is the captain of the Whitebeard Pirates?", "Edward Newgate", "He's known as the 'Strongest Man in the World'", "His nickname is 'Whitebeard'", "His first name is E_____", "easy"),
            ...
            ("Which Shichibukai is known as the 'Tyrant'?", "Bartholomew Kuma", "He's a cyborg", "He has paw pads on his hands", "His first name is B__________", "normal"),
            ...
            ("Which Devil Fruit allows the user to create earthquakes?", "Gura Gura no Mi", "It was Whitebeard's fruit", "It's considered the strongest Paramecia", "It starts with 'Gura'", "normal"),
            ("What is the name of the technique that allows users to coat themselves in Armament Haki?", "Busoshoku Haki", "It's a type of Haki", "It turns the user's body black", "It starts with 'Buso'", "normal"),
            ("Who is the current Fleet Admiral of the Marines?", "Akainu", "He has magma powers", "He killed Ace", "His name means 'Red Dog'", "normal"),
            ...
            ("Which former Shichibukai is known as the 'Knight of the Sea'?", "Jinbe", "He's a fishman", "He joined the Straw Hat crew", "His name starts with 'J'", "normal"),
            ...
            ("Who is the captain of the Rocks Pirates?", "Rocks D. Xebec", "He was Garp and Roger's greatest enemy", "He was defeated at God Valley", "His last name is 'Rocks'", "hard"),
            ...
            ("Which Devil Fruit did Sabo eat?", "Mera Mera no Mi", "It was previously Ace's fruit", "It's a fire Logia", "It starts with 'Mera'", "normal"),
            ("What is the name of the technique Luffy uses to harden his body?", "Armament Haki", "It's a type of Haki", "It turns body parts black", "It starts with 'Arma'", "normal"),
