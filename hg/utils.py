...
def should_execute_event(alive_count: int, round_num: int) -> bool:
    """Determine if an event should happen this round - ALWAYS TRUE for faster pace"""
    # With the new combined events system, we always want events to happen
    # The number of events per round is controlled in execute_combined_events
    return True
